...
TenantContext.setClinicId(
        jwtService.extractClinicId(token)
);

TenantContext.setDoctorId(
        jwtService.extractDoctorId(token)
);
...
AccessContext.setClinicId(clinicId);
AccessContext.setDoctorId(doctorId);
AccessContext.setRole(role);
            }
        }
